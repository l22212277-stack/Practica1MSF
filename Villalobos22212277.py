...
R,L,C = 4.7E3,680E-6,47E-6
num = [C*L*R,C*R**2+L,R]
den = [3*C*R*L,5*C*(R**2)+L,2*R]
sys = ctrl.tf(num,den)
...
plt.plot(t,PAu[0], '--', color = clr2, label = 'Vs(t)1')
...
plt.plot(t,PAu[1], '--', color = clr2, label = 'Vs(t)1')
...
plt.plot(t,PAu[2], '--', color = clr2, label = 'Vs(t)1')
...
plt.plot(t,PAu[3], '--', color = clr2, label = 'Vs(t)1')
